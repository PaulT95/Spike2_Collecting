...
;STOP SAMPLING/QUIT AND PUT DIGOUT 0
...
;;;;;;;; Specific ch value comparison
VALCHK: 'A DAC   1,4
          VAR     V1,level  ;level to cross
          MOV     V1, V30
          VAR     V2          ;to hold the last data ;in 16bit value voltage
          VAR     V3,low         ;some sort of hysteresis level
          MOV     V3, V31
          CHAN    V2, 2  ;Read data of Angle
         ;DIGOUT [....ii..] ;trigger rot

BELOW:   CHAN    V2, 2  ;Read data of Angle
         BGT     V2,low,below   ;wait for below

ABOVE:   CHAN    V2, 2  ;Read data of Angle
         BLE     V2,level,above ;wait for above
